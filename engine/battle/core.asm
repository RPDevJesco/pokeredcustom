...
.noLinkBattle
	; GAME STATS: battle turns
	push_all
	ld de, wStatsBattleTurns
	farcall GameStatsIncrement2Byte
	pop_all
...
.poisoned
	...
	; GAME STATS: damage (poisoned, burned)
	push hl
	push de
	push bc
	xor a
	...
	ld a, c
	ld [wStatsBuffer + 3], a
	farcall GameStatsTotalDamageBuffer
	farcall GameStatsActualDamageBuffer
	pop bc
	pop de
	pop hl
.notBurnedOrPoisoned
...
EnemyMonFaintedText:
	...
	text_asm
	; GAME STATS: enemy mon fainted (battle)
	push_all
	ld de, wStatsEnemyPokemonFainted
	farcall GameStatsIncrement2Byte
	pop_all
	jp TextScriptEnd
...
; win money
	...
	ld c, $3
	predef AddBCDPredef
	; GAME STATS: money gained (battle won)
	push_all
	xor a
	ld [wStatsBuffer + 0], a
	ld a, [wAmountMoneyWon + 0]
	ld [wStatsBuffer + 1], a
...
PlayerMonFaintedText:
	...
	text_asm
	; GAME STATS: player mon fainted (battle)
	push_all
	ld de, wStatsPlayerPokemonFainted
	farcall GameStatsIncrement2Byte
	pop_all
	jp TextScriptEnd
...
CantEscapeText:
	...
	text_asm
	; GAME STATS: failed to run
	push_all
	ld de, wStatsFailedRuns
	farcall GameStatsIncrement2Byte
	pop_all
	jp TextScriptEnd
...
SwitchPlayerMon:
	callfar RetreatMon
	; GAME STATS: switch out
	push_all
	ld de, wStatsSwitchout
	farcall GameStatsIncrement2Byte
	pop_all
	ld c, 50
	call DelayFrames
...
PlayerCanExecuteMove:
	; GAME STATS: player battle turn
	push_all
	ld de, wStatsPlayerTurns
	farcall GameStatsIncrement2Byte
	pop_all
...
.ParalysisCheck
	...
	bit PAR, [hl]
	jr z, .BideCheck
	; GAME STATS: player turns paralyzed
	push_all
	ld de, wStatsPlayerTurnsParalyzed
	farcall GameStatsIncrement2Byte
	pop_all
	call BattleRandom
...
FastAsleepText:
	...
	text_asm
	; GAME STATS: is asleep
	push_all
	ld de, wStatsTurnsAsleep
	farcall GameStatsPlayerOrEnemy
	pop_all
	jp TextScriptEnd
...
FullyParalyzedText:
	...
	text_asm
	; GAME STATS: fully paralyzed
	push_all
	ld de, wStatsTurnsParalyzedFully
	farcall GameStatsPlayerOrEnemy
	pop_all
	jp TextScriptEnd
...
IsConfusedText:
	...
	text_asm
	; GAME STATS: turns confused
	push_all
	ld de, wStatsTurnsConfused
	farcall GameStatsPlayerOrEnemy
	pop_all
	jp TextScriptEnd
...
HurtItselfText:
	...
	text_asm
	; GAME STATS: confused hit self
	push_all
	ld de, wStatsTurnsConfusedHitSelf
	farcall GameStatsPlayerOrEnemy
	pop_all
	jp TextScriptEnd
...
AttackMissedText:
	...
	text_asm
	; GAME STATS: move missed
	push_all
	ld de, wStatsMovesMissed
	farcall GameStatsIncrement2Byte
	pop_all
	jp TextScriptEnd
...
CriticalHitText:
	...
	text_asm
	; GAME STATS: critical hit
	push_all
	ld de, wStatsCriticals
	farcall GameStatsPlayerOrEnemy
	pop_all
	jp TextScriptEnd
...
ApplyDamageToEnemyPokemon:
	; GAME STATS: player total damage dealt
	push_all
	xor a
	ld [wStatsBuffer + 0], a
	ld [wStatsBuffer + 1], a
	...
	ld a, [wDamage + 1]
	ld [wStatsBuffer + 3], a
	ld de, wStatsPlayerTotalDamage + 3
	farcall GameStatsAddBuffer4Byte
	pop_all
	ld hl, wDamage
	ld a, [hli]
	ld b, a
...
; equal to how much HP the pokemon had before the attack
	...
	ld [hl], a
.animateHpBar
	; GAME STATS: player actual damage dealt
	push_all
	xor a
	ld [wStatsBuffer + 0], a
	ld [wStatsBuffer + 1], a
	...
	ld a, [wDamage + 1]
	ld [wStatsBuffer + 3], a
	ld de, wStatsPlayerActualDamage + 3
	farcall GameStatsAddBuffer4Byte
	pop_all
	ld hl, wEnemyMonMaxHP
	ld a, [hli]
...
ApplyDamageToPlayerPokemon:
	; GAME STATS: enemy total damage dealt
	push_all
	xor a
	ld [wStatsBuffer + 0], a
	ld [wStatsBuffer + 1], a
	...
	ld a, [wDamage + 1]
	ld [wStatsBuffer + 3], a
	ld de, wStatsEnemyTotalDamage + 3
	farcall GameStatsAddBuffer4Byte
	pop_all
	ld hl, wDamage
	ld a, [hli]
...
; equal to how much HP the pokemon had before the attack
	...
	ld [hl], a
.animateHpBar
	; GAME STATS: enemy actual damage dealt
	push_all
	xor a
	ld [wStatsBuffer + 0], a
	ld [wStatsBuffer + 1], a
	...
	ld a, [wDamage + 1]
	ld [wStatsBuffer + 3], a
	ld de, wStatsEnemyActualDamage + 3
	farcall GameStatsAddBuffer4Byte
	pop_all
	ld hl, wBattleMonMaxHP
	ld a, [hli]
...
; note that this means that even the highest accuracy is still just a 255/256 chance, not 100%
	...
	; GAME STATS: move hit
	push_all
	ld de, wStatsMovesHit
	farcall GameStatsPlayerOrEnemy
	farcall GameStatsRecordTypeEffectiveness
	pop_all
	ret
.moveMissed
	xor a
...
EnemyCanExecuteChargingMove:
	...
	call CopyToStringBuffer
EnemyCanExecuteMove:
	; GAME STATS: enemy battle turn
	push_all
	ld de, wStatsEnemyTurns
	farcall GameStatsIncrement2Byte
	pop_all
	xor a
	ld [wMonIsDisobedient], a
...
.checkIfParalysed
	...
	; GAME STATS: enemy turns paralyzed
	push_all
	ld de, wStatsEnemyTurnsParalyzed
	farcall GameStatsIncrement2Byte
	pop_all
	call BattleRandom
...
InitBattleCommon:
	...
	; GAME STATS: trainer battle
	push_all
	ld de, wStatsTrainerBattles
	farcall GameStatsIncrement2Byte
	pop_all
	callfar ReadTrainer
...
InitWildBattle:
	; GAME STATS: wild battle
	push_all
	ld de, wStatsWildBattles
	farcall GameStatsIncrement2Byte
	pop_all
	ld a, $1
	ld [wIsInBattle], a
