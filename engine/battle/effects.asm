...
PoisonedText:
	...
	text_asm
	; GAME STATS: was poisoned
	push_all
	ld de, wStatsWasPoisoned
...
BadlyPoisonedText:
	...
	text_asm
	; GAME STATS: was poisoned badly
	push_all
	ld de, wStatsWasPoisonedBadly
	farcall GameStatsPlayerOrEnemy
	pop_all
	jp TextScriptEnd
...
BurnedText:
	...
	text_asm
	; GAME STATS: was burned
	push_all
	ld de, wStatsWasBurned
	farcall GameStatsPlayerOrEnemy
	pop_all
	jp TextScriptEnd
...
FrozenText:
	...
	text_asm
	; GAME STATS: was frozen
	push_all
	ld de, wStatsWasFrozen
	farcall GameStatsPlayerOrEnemy
	pop_all
	jp TextScriptEnd
...
BecameConfusedText:
	...
	text_asm
	; GAME STATS: became confused
	push_all
	ld de, wStatsBecameConfused
	farcall GameStatsPlayerOrEnemy
	pop_all
	jp TextScriptEnd
...
ParalyzedMayNotAttackText:
	...
	text_asm
	; GAME STATS: was paralyzed
	push_all
	ld de, wStatsWasParalyzed
	farcall GameStatsPlayerOrEnemy
	pop_all
	jp TextScriptEnd
