...
.skipSettingFlag1
	...
	; GAME STATS: item sold (mart)
	push_all
	xor a
	ld [wStatsBuffer + 0], a  ; MSB
	ld a, [wItemQuantity]
	ld [wStatsBuffer + 1], a  ; LSB
	ld de, wStatsItemsSold
	farcall GameStatsAddBuffer2Byte
	pop_all
	jp .sellMenuLoop
.unsellableItem
...
.buyItem
	...
	jr nc, .bagFull
	; GAME STATS: item bought (mart)
	push_all
	xor a
	ld [wStatsBuffer + 0], a  ; MSB
	ld a, [wItemQuantity]
	ld [wStatsBuffer + 1], a  ; LSB
	ld de, wStatsItemsBought
	farcall GameStatsAddBuffer2Byte
	pop_all
