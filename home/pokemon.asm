...
GetMonHeader::
	...
	jr z, .specialID
	; cp MEW ; TODO_BACKPORT
	; jr z, .mew ; TODO_BACKPORT
...
.specialID
	...
	inc hl
	ld [hl], d
; 	jr .done ; TODO_BACKPORT
; .mew ; TODO_BACKPORT
; 	ld hl, MewBaseStats ; TODO_BACKPORT
; 	ld de, wMonHeader ; TODO_BACKPORT
; 	ld bc, BASE_DATA_SIZE ; TODO_BACKPORT
; 	ld a, BANK(MewBaseStats) ; TODO_BACKPORT
; 	call FarCopyData ; TODO_BACKPORT
.done
	ld a, [wd0b5]
	ld [wMonHIndex], a
	pop af
