BluesHouse_Script:
	...
	ld hl, BluesHouse_TrainerHeaders
...
BluesHouse_TextPointers:
	...
	dw_const Oak1,       TEXT_OAK1
	dw_const Oak2,       TEXT_OAK2
	dw_const Oak3,       TEXT_OAK3

BluesHouse_TrainerHeaders:
	def_trainers
BluesHouse_TrainerHeader0:
	trainer EVENT_BEAT_OAK_0, 0, PalletTownText9, PalletTownText9, PalletTownText9
BluesHouse_TrainerHeader1:
	trainer EVENT_BEAT_OAK_1, 1, PalletTownText9, PalletTownText9, PalletTownText9
BluesHouse_TrainerHeader2:
	trainer EVENT_BEAT_OAK_2, 2, PalletTownText9, PalletTownText9, PalletTownText9
	db -1 ; end
...
PalletTownText9:
	text_far _PalletTownText9
	text_end

Oak1:
	text_asm
	ld hl, BluesHouse_TrainerHeader0
	call TalkToTrainer
	jp TextScriptEnd
Oak2:
	text_asm
...
; 	set 6, [hl]
; 	set 7, [hl]
; 	ld hl, PalletTownText9
; 	ld de, PalletTownText9
