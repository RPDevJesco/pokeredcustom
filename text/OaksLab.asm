...
_OaksLabYouWantCharmanderText::
	...
	line "fire #MON," ; TODO_STARTER
	cont "CHARMANDER?" ; TODO_STARTER
	done

_OaksLabYouWantSquirtleText::
	text "So! You want the"
	line "water #MON," ; TODO_STARTER
	cont "SQUIRTLE?" ; TODO_STARTER
	done

_OaksLabYouWantBulbasaurText::
	text "So! You want the"
	line "#MON" ; TODO_STARTER
	cont "that's cross gen?" ; TODO_STARTER
	done
